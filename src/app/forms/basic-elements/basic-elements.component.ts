...
export class BasicElementsComponent implements OnInit {
  ...
  selDist: FormControl;
  // selCategory: FormControl;
  selCrop: FormControl;
  selOthers: FormControl;
  areaOfCult: FormControl;
  quantitySown: FormControl;
...
//   changeCategory(cat) {
//     this.catList = this.cropCategory.find(cc => cc.category == cat).catList;
//   }
  ...
  ngOnInit() {
    ...
    this.produceForm = new FormGroup({
      ...
      selCrop : new FormControl(''), 
      selOthers : new FormControl(''), 
      areaOfCult : new FormControl('', Validators.required), 
    ...
    this.getJSON().subscribe(data => {
      ...
      console.log('Crop list: ' + this.cropList.length + '' + this.cropList)
  ...
  submit() {
    ...
    let postData = {
      ...
      "cropName" : this.produceForm.value.selCrop,
      "district" :this.produceForm.value.selDist,
      "state" : this.produceForm.value.selState,
      "areaOfLand" : this.produceForm.value.areaOfCult,
      "quantitySown":this.produceForm.value.quantitySown,
      "yieldExpected" : this.produceForm.value.expProduce,
      "harvestPeriod" : this.produceForm.value.harvestPeriod + " " + this.produceForm.value.harvestYear,
    }
